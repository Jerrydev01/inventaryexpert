...
| `17_storage.sql`                | Storage buckets + policies     | 01, 03, 05, 07         |
| `18_rpc_transaction_engine.sql` | Inventory transaction RPCs     | 03, 07, 08, 09         |
| `19_sector_options.sql`         | Sector options RPC             | 00                     |
...
4. Continue in order through `19_sector_options.sql`

> Alternatively, concatenate all files and run in one shot:
>
> ```sh
> cat supabase/{00..19}_*.sql | pbcopy   # macOS — pastes to clipboard
> ```
